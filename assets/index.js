...
const deadlines = [
  // ===== TDS =====
  { id: "tds-ga1", course: "TDS", title: "GA 1 – Setup", category: "Graded Assignment", releaseDate: "2026-02-06", dueDate: "2026-02-18", url: "https://exam.sanand.workers.dev/tds-2026-01-ga1" },
  { id: "tds-ga2", course: "TDS", title: "GA 2 – Deploy", category: "Graded Assignment", releaseDate: "2026-02-13", dueDate: "2026-02-22", url: "https://exam.sanand.workers.dev/tds-2026-01-ga2" },
  { id: "tds-ga3", course: "TDS", title: "GA 3 – Source", category: "Graded Assignment", releaseDate: "2026-02-20", dueDate: "2026-03-01", url: "https://exam.sanand.workers.dev/tds-2026-01-ga3" },
  { id: "tds-ga4", course: "TDS", title: "GA 4 – Wrangle", category: "Graded Assignment", releaseDate: "2026-02-27", dueDate: "2026-03-08", url: "https://exam.sanand.workers.dev/tds-2026-01-ga4" },
  { id: "tds-ga5", course: "TDS", title: "GA 5 – Analyze", category: "Graded Assignment", releaseDate: "2026-03-06", dueDate: "2026-03-20", url: "https://exam.sanand.workers.dev/tds-2026-01-ga5" },
  { id: "tds-ga6", course: "TDS", title: "GA 6 – Test", category: "Graded Assignment", releaseDate: "2026-03-13", dueDate: "2026-03-22", url: "https://exam.sanand.workers.dev/tds-2026-01-ga6" },
  { id: "tds-ga7", course: "TDS", title: "GA 7 – Present", category: "Graded Assignment", releaseDate: "2026-03-20", dueDate: "2026-03-29", url: "https://exam.sanand.workers.dev/tds-2026-01-ga7" },
  { id: "tds-ga8", course: "TDS", title: "GA 8 – Package", category: "Graded Assignment", releaseDate: "2026-03-27", dueDate: "2026-04-08", url: "https://exam.sanand.workers.dev/tds-2026-01-ga8" },
  { id: "tds-p1", course: "TDS", title: "Project 1", category: "Project", releaseDate: "2026-02-11", dueDate: "2026-03-30", weight: "20%", url: "https://exam.sanand.workers.dev/tds-2026-01-p1" },
  { id: "tds-p2", course: "TDS", title: "Project 2", category: "Project", releaseDate: "2026-03-06", dueDate: "2026-04-13", weight: "20%", url: "https://exam.sanand.workers.dev/tds-2026-01-p2" },
  { id: "tds-roe", course: "TDS", title: "Remote Online Exam", category: "Exam", dueDate: "2026-04-05", weight: "20%", url: "https://exam.sanand.workers.dev/tds-2026-01-roe", notes: "45 mins, open internet, objective" },
  { id: "tds-end", course: "TDS", title: "End Term Exam", category: "Exam", dueDate: "2026-05-10", weight: "20%", notes: "In-person, no internet, mandatory" },
  // ===== MLP =====
  { id: "mlp-ka1", course: "MLP", title: "KA 1", category: "Kaggle Assignment", releaseDate: "2026-03-06", dueDate: "2026-03-18", notes: "Peer review by Mar 22" },
  { id: "mlp-ka2", course: "MLP", title: "KA 2", category: "Kaggle Assignment", releaseDate: "2026-03-25", dueDate: "2026-04-02", notes: "Peer review by Apr 6" },
  { id: "mlp-ka3", course: "MLP", title: "KA 3", category: "Kaggle Assignment", releaseDate: "2026-04-10", dueDate: "2026-04-17", notes: "Peer review by Apr 21" },
  { id: "mlp-oppe1", course: "MLP", title: "OPPE 1", category: "Programming Exam", dueDate: "2026-04-04", weight: "20%", notes: "Online proctored programming exam" },
  { id: "mlp-oppe2", course: "MLP", title: "OPPE 2", category: "Programming Exam", dueDate: "2026-04-26", weight: "20%", notes: "Online proctored programming exam" },
  { id: "mlp-end", course: "MLP", title: "End Term Exam", category: "Exam", dueDate: "2026-05-10" },
  // ===== MAD II =====
  { id: "mad2-pa", course: "MAD II", title: "Programming Assignments (Wk 1-2)", category: "Programming Assignment", releaseDate: "2026-02-15", dueDate: "2026-03-01", weight: "5% (GAA)", notes: "Auto evaluated" },
  { id: "mad2-qz1", course: "MAD II", title: "Quiz 1", category: "Quiz", dueDate: "2026-03-15", notes: "Objective + Descriptive, in-person" },
  { id: "mad2-qz2", course: "MAD II", title: "Quiz 2", category: "Quiz", dueDate: "2026-04-12", notes: "Objective + Descriptive, in-person" },
  { id: "mad2-end", course: "MAD II", title: "End Term Exam", category: "Exam", dueDate: "2026-05-10", notes: "100% Objective, in-person" },
  // ===== GenAI =====
  { id: "genai-qz1", course: "GenAI", title: "Quiz 1", category: "Quiz", dueDate: "2026-03-15", weight: "20%" },
...
const weeklyGADeadlines = [
  ...
  { week: 2, dueDate: "2026-02-22" },
  { week: 3, dueDate: "2026-03-01" },
  { week: 4, dueDate: "2026-03-08" },
  { week: 5, dueDate: "2026-03-20" },
  { week: 6, dueDate: "2026-03-22" },
  { week: 7, dueDate: "2026-03-29" },
  { week: 8, dueDate: "2026-04-08" },
  { week: 9, dueDate: "2026-04-15" },
  { week: 10, dueDate: "2026-04-19" },
  { week: 11, dueDate: "2026-05-03" },
  { week: 12, dueDate: "2026-05-03" }
];
function getWeeklyGAs() {
  const entries = [];
  for (let i = 0; i < 11 && i < weeklyGADeadlines.length; i++) {
    entries.push({
      id: `mad2-wga-${i + 1}`,
      course: "MAD II",
      title: `GA ${i + 1}`,
      category: "Graded Assignment",
      dueDate: weeklyGADeadlines[i].dueDate
    });
  }
  for (let i = 0; i < 9 && i < weeklyGADeadlines.length; i++) {
    entries.push({
      id: `genai-wga-${i + 1}`,
      course: "GenAI",
      title: `GA ${i + 1}`,
  ...
  for (let i = 0; i < 10 && i < weeklyGADeadlines.length; i++) {
    entries.push({
      id: `mlp-wga-${i + 1}`,
      course: "MLP",
      title: `GA ${i + 1}`,
...
function getAllDeadlines() {
  return [...deadlines, ...getWeeklyGAs()].sort(
    (a, b) => new Date(a.dueDate).getTime() - new Date(b.dueDate).getTime()
  );
}
const courseGrading = {
  TDS: "T = 0.2 GAA + 0.2 ROE + 0.2 P1 + 0.2 P2 + 0.2 F",
  MLP: "T = 0.1 GAA + 0.30 F + 0.20 OPPE1 + 0.20 OPPE2 + 0.20 KA",
  "MAD II": "T = 0.05 GAA + max(0.6F + 0.25·max(Qz1,Qz2), 0.4F + 0.25·Qz1 + 0.3·Qz2)",
  GenAI: "T = 0.1 GAA + 0.2 Qz1 + 0.2 Qz2 + 0.25 F + 0.1 NPPE1 + 0.15 NPPE2",
  "MAD I": "Project Based Grading"
};
const colorMap = {
  TDS: "bg-course-tds shadow-[0_0_12px_-2px_rgba(var(--course-tds),0.4)]",
  MLP: "bg-course-mlp shadow-[0_0_12px_-2px_rgba(var(--course-mlp),0.4)]",
  "MAD II": "bg-course-mad2 shadow-[0_0_12px_-2px_rgba(var(--course-mad2),0.4)]",
  GenAI: "bg-course-genai shadow-[0_0_12px_-2px_rgba(var(--course-genai),0.4)]",
  "MAD I": "bg-course-mad1 shadow-[0_0_12px_-2px_rgba(var(--course-mad1),0.4)]"
};
function CourseBadge({
  ...
  const sizeStyles = {
    ...
    md: "px-2.5 py-0.5 text-[10px] font-extrabold",
    lg: "px-3 py-1 text-[11px] font-black uppercase tracking-widest"
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "span",
    {
      className: cn(
        "inline-flex items-center rounded-full text-white ring-1 ring-white/10",
        sizeStyles[size2],
        colorMap[course],
        className
      ),
...
function getCountdown(dueDate) {
  const due = /* @__PURE__ */ new Date(dueDate + "T23:59:59");
  const now = /* @__PURE__ */ new Date();
  if (isPast(due) && !isToday(due)) return "Past due";
  if (isToday(due)) return "Due today!";
  const days = differenceInDays(due, now);
  if (days === 0) {
...
const statusStyles = {
  ...
  "due-today": "status-overdue font-bold",
  "due-soon": "status-due-soon font-semibold",
  upcoming: "status-upcoming",
  far: "status-upcoming opacity-60"
};
const allCourses = ["TDS", "MLP", "MAD II", "GenAI", "MAD I"];
const sections = [
  {
    title: "WEEKLY GA",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FileCode, { className: "h-4 w-4" }),
    filter: (d) => d.category === "Graded Assignment" && d.course !== "TDS",
    windowDays: 14,
  ...
  },
  {
    ...
    filter: (d) => d.course === "TDS",
    windowDays: 90,
    color: "border-t-course-tds",
    link: { title: "TDS Portal", url: "https://tds.s-anand.net/" },
    limit: 3
  },
  {
    title: "OPPE",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Laptop, { className: "h-4 w-4" }),
    filter: (d) => d.category === "Programming Exam" || d.category === "Programming Assignment",
    windowDays: 90,
    color: "border-t-course-mlp"
  },
  {
    title: "KAGGLE",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "h-4 w-4" }),
    filter: (d) => d.category === "Kaggle Assignment",
    windowDays: 60,
    color: "border-t-course-mlp"
  },
  {
    title: "QUIZZES",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PenLine, { className: "h-4 w-4" }),
    filter: (d) => d.category === "Quiz",
    windowDays: 60,
    color: "border-t-course-genai"
  },
  {
    title: "EXAMS",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-4 w-4" }),
    filter: (d) => d.category === "Exam" && d.course !== "TDS",
    windowDays: 90,
    color: "border-t-status-overdue"
  }
];
function DeadlineRow({ title, dueDate, courses, weight, url }) {
  const status = getDeadlineStatus(dueDate);
  const countdown = getCountdown(dueDate);
  statusStyles[status].split(" ")[0];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group/row flex items-center justify-between gap-4 py-4 border-b border-white/[0.03] last:border-0 hover:bg-white/[0.02] transition-colors duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 min-w-0 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 shrink-0 items-center", children: courses.map((course, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        CourseBadge,
        {
          course,
          size: "sm",
          className: cn(
            "relative transition-all duration-500 group-hover/row:scale-110",
            i === 0 ? "z-[4]" : i === 1 ? "z-[3]" : i === 2 ? "z-[2]" : "z-[1]"
          )
        },
        course
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] font-bold text-foreground tracking-tight leading-none transition-colors whitespace-nowrap overflow-hidden text-ellipsis", children: title })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6 shrink-0", children: [
      url ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          ...
          className: "flex h-6 w-8 shrink-0 items-center justify-center rounded-lg bg-primary/10 border border-primary/20 hover:bg-primary/20 hover:border-primary/40 transition-all group/link",
          title: "Open Link",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-3 w-3 text-primary" })
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-6 w-8 shrink-0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground font-black uppercase tracking-[0.2em] hidden md:inline opacity-60 group-hover/row:opacity-100 transition-opacity w-14 text-right whitespace-nowrap", children: format(new Date(dueDate), "MMM d") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn(
        "text-[9px] font-black px-3 py-1.5 rounded-xl w-[125px] whitespace-nowrap text-center uppercase tracking-[0.15em] transition-all duration-300",
        "ring-1 ring-inset",
        status === "overdue" || status === "due-today" ? "bg-status-overdue/10 text-status-overdue ring-status-overdue/20" : status === "due-soon" ? "bg-status-due-soon/10 text-status-due-soon ring-status-due-soon/20" : "bg-white/5 text-muted-foreground ring-white/10 opacity-60"
      ), children: countdown })
    ] })
  ] });
}
function SectionBox({ config, deadlines: deadlines2, style }) {
  const now = /* @__PURE__ */ new Date();
  ...
  const items = reactExports.useMemo(() => {
    const filtered = deadlines2.filter(config.filter).filter((d) => {
      const days = differenceInDays(new Date(d.dueDate), now);
      return days >= -2 && days <= config.windowDays;
    });
    const simplified = filtered.map((d) => ({
      ...d,
      displayTitle: d.title.replace("Online programming exam", "OPPE").replace("Programming Assignments", "PA").replace("Remote Online Exam", "ROE").replace("End Term Exam", "ET").replace("exam 1", "1").replace("exam 2", "2").replace("Project M", "Milestone ").replace("Project ", "Milestone ").replace(" (Final Submission)", "").replace(" (Final)", "").replace("(Wk 1-2)", "").split(" – ")[0].split(" - ")[0].trim()
    }));
    const groups = {};
    simplified.forEach((d) => {
      const key = `${d.displayTitle}-${d.dueDate}`;
      if (!groups[key]) {
        groups[key] = { id: key, title: d.displayTitle, dueDate: d.dueDate, courses: [], weight: d.weight, url: d.url };
      }
      if (!groups[key].courses.includes(d.course)) {
        groups[key].courses.push(d.course);
      }
    });
    const sorted = Object.values(groups).sort((a, b) => {
      const aIsOPPE = a.title.toUpperCase().includes("OPPE");
      const bIsOPPE = b.title.toUpperCase().includes("OPPE");
      if (aIsOPPE && !bIsOPPE) return -1;
      if (!aIsOPPE && bIsOPPE) return 1;
      return new Date(a.dueDate).getTime() - new Date(b.dueDate).getTime();
    });
    return config.limit ? sorted.slice(0, config.limit) : sorted;
  }, [config.filter, config.title, config.windowDays, config.limit, deadlines2, now]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      className: cn(
        "group glass-glow rounded-[2rem] overflow-hidden flex flex-col p-6",
        "animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out"
      ),
      style: { ...style, "--x": `${mousePos.x}px`, "--y": `${mousePos.y}px` },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bento-glow" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex items-center gap-3 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2.5 rounded-2xl bg-primary/10 text-primary", children: config.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[13px] font-black tracking-[0.2em] text-foreground/80", children: config.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto flex h-6 w-6 items-center justify-center rounded-full bg-primary/20 text-[10px] font-black text-primary", children: items.length })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 space-y-1 mb-6", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          DeadlineRow,
          {
            title: item.title,
        ...
        config.link && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 pt-4 border-t border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: config.link.url,
            target: "_blank",
            rel: "noopener noreferrer",
            className: "flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 hover:border-primary/30 transition-all group/link w-fit",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-3 w-3 text-primary/60 group-hover/link:text-primary transition-colors" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-muted-foreground group-hover/link:text-foreground transition-colors", children: config.link.title })
            ]
          }
        ) })
      ]
...
function ProjectBox({ course, deadlines: deadlines2, style }) {
  const [mousePos, setMousePos] = reactExports.useState({ x: 0, y: 0 });
  const handleMouseMove = (e) => {
    const rect = e.currentTarget.getBoundingClientRect();
    setMousePos({ x: e.clientX - rect.left, y: e.clientY - rect.top });
  };
  const projectItems = deadlines2.filter((d) => d.course === course && d.category === "Project" && !d.title.toLowerCase().includes("submission")).map((d) => ({
    ...d,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      onMouseMove: handleMouseMove,
      className: "group glass-glow rounded-[2rem] overflow-hidden flex flex-col p-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out hover:scale-[1.02] transition-all",
      style: { "--x": `${mousePos.x}px`, "--y": `${mousePos.y}px` },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bento-glow" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex items-center justify-between mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CourseBadge, { course, size: "lg" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] font-black uppercase tracking-[0.2em] text-foreground/40 italic", children: [
              "Final: ",
              finalDates[course]
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-2 rounded-full bg-primary animate-pulse shadow-[0_0_10px_rgba(var(--primary),0.5)]" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 space-y-4 mb-8", children: projectItems.map((item) => {
          const status = getDeadlineStatus(item.dueDate);
          const countdown = getCountdown(item.dueDate);
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between group/item p-4 rounded-2xl bg-white/5 hover:bg-white/10 transition-all border border-white/5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-black uppercase tracking-widest text-foreground/80 group-hover/item:text-primary transition-colors", children: item.displayTitle }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-muted-foreground mt-1", children: format(new Date(item.dueDate), "MMMM d, yyyy") })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn(
              "text-[9px] font-black px-3 py-1.5 rounded-xl min-w-[90px] text-center uppercase tracking-widest ring-1 ring-inset",
              status === "overdue" || status === "due-today" ? "bg-status-overdue/10 text-status-overdue ring-status-overdue/20" : status === "due-soon" ? "bg-status-due-soon/10 text-status-due-soon ring-status-due-soon/20" : "bg-white/5 text-muted-foreground ring-white/10 opacity-60"
            ), children: countdown })
          ] }, item.id);
        }) }),
        courseLinks.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 pt-6 border-t border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: courseLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: link.url,
            target: "_blank",
            rel: "noopener noreferrer",
            className: "flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 hover:border-primary/30 transition-all group/link",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary/60 group-hover/link:text-primary transition-colors", children: link.icon || /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "h-3 w-3" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-muted-foreground group-hover/link:text-foreground transition-colors", children: link.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-2.5 w-2.5 opacity-0 group-hover/link:opacity-40 transition-opacity ml-1" })
            ]
          },
          link.title
        )) }) })
...
function GradingCard() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-glow rounded-[2rem] p-8 md:col-span-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "flex items-center gap-3 text-[13px] font-black uppercase tracking-[0.2em] text-foreground/80 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2.5 rounded-2xl bg-primary/10 text-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-4 w-4" }) }),
      "Course Grading Formulas"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 sm:grid-cols-2 lg:grid-cols-4", children: allCourses.filter((c) => c !== "MAD I").map((course) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 rounded-3xl bg-secondary/20 hover:bg-secondary/40 transition-all group border border-white/[0.03]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CourseBadge, { course, className: "mb-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "block text-[10px] text-muted-foreground font-mono leading-relaxed opacity-70 group-hover:opacity-100 transition-opacity", children: courseGrading[course] })
    ] }, course)) })
  ] });
}
function Dashboard() {
  const allDeadlines = reactExports.useMemo(() => getAllDeadlines(), []);
  const [showAll, setShowAll] = reactExports.useState(false);
  const [view, setView] = reactExports.useState("theory");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen pb-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 py-4 px-6 sm:px-12 bg-background/80 backdrop-blur-md border-b border-white/5 transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl flex items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-12 w-12 items-center justify-center rounded-2xl bg-primary text-white shadow-[0_0_20px_rgba(var(--primary),0.3)] shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "h-6 w-6" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-2xl font-black text-foreground tracking-tighter leading-tight", children: [
            "IITM ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary italic", children: "Tracker" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em]", children: "Dashboard · 2026" })
        ] })
      ] }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: cn(
              ...
              view === "projects" ? "bg-primary text-white shadow-lg shadow-primary/20" : "text-muted-foreground hover:text-foreground"
            ),
            children: "Projects"
          }
        )
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex items-center justify-end gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            onClick: () => setShowAll(!showAll),
            className: cn(
              "hidden md:flex items-center h-10 gap-2 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md px-4 text-[10px] font-black uppercase tracking-[0.15em] transition-all duration-300",
              showAll ? "bg-primary/20 text-primary border-primary/30" : "text-muted-foreground hover:bg-white/10"
            ),
            title: showAll ? "Switch to Focus Mode" : "Switch to Timeline Mode",
            children: [
              showAll ? /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { className: "h-3.5 w-3.5" }),
              showAll ? "Focus" : "Timeline"
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-[1px] bg-white/10 mx-1 hidden md:block" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: toggleTheme,
            className: "flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300 group",
            title: theme === "dark" ? "Switch to Light Mode" : "Switch to Dark Mode",
            children: theme === "dark" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "h-4.5 w-4.5 text-yellow-500 transition-transform group-hover:rotate-45" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "h-4.5 w-4.5 text-primary transition-transform group-hover:-rotate-12" })
          }
        )
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "mx-auto max-w-7xl px-6 sm:px-12 py-6", children: view === "theory" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 grid-cols-1 md:grid-cols-2", children: [
      sections.map((config, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionBox,
        {
          config: showAll ? { ...config, windowDays: 365, limit: void 0 } : config,
          deadlines: allDeadlines,
          style: { animationDelay: `${index2 * 100}ms` }
        },
        config.title
      )),
      /* @__PURE__ */ jsxRuntimeExports.jsx(GradingCard, {})
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-8 grid-cols-1 md:grid-cols-2", children: ["MLP", "GenAI", "MAD I", "MAD II"].map((course, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      ProjectBox,
      {
        course,
        deadlines: allDeadlines,
